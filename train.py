...
path_to_chkpt = 'gdrive/My Drive/Colab Notebooks/Face_Landmarks/model_weights.tar'
path_to_backup = 'gdrive/My Drive/Colab Notebooks/Face_Landmarks/backup_model_weights.tar'
